...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 flex bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 border-b transition-all duration-300 ease-in-out ${
      isExpanded || isHovered ? "lg:left-[269px] lg:right-0" : "lg:left-[90px] lg:right-0"
    } left-0 right-0`}>
      <div className="flex flex-col items-center justify-between grow w-full lg:flex-row lg:px-6">
